...
describe('text', () => {
  ...
  it('should have `hello world` with undefined component', async () => {
  ...
  it('should style first word by string split', async () => {
  ...
  it('should style first word by index position', async () => {
