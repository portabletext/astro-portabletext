...
import type {AnnotatedMapBlock, CodeBlock} from './types'
...
export const blocks: (PortableTextBlock | CodeBlock | AnnotatedMapBlock)[] = [
  {
    ...
    style: 'h1',
    markDefs: [],
    children: [{_type: 'span', text: '@portabletext/astro demo'}],
  },
  {
    _type: 'block',
  ...
  },
  {
    ...
    _key: 'cool-custom',
    style: 'normal',
    markDefs: [{_type: 'link', _key: 'lllink', href: 'https://shiki.style/'}],
    children: [
      {
        _type: 'span',
        text: 'Aside from that, you can drop in pretty much any data you want, as long as you define an Astro component to render it. Here is a code block, highlighted at build time by Astro’s built-in ',
      },
      {_type: 'span', text: 'Code component (Shiki)', marks: ['lllink']},
